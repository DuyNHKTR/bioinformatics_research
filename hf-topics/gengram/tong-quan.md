...
`Gengram` là một genomic `foundation model` rất mới, xuất hiện trên `Hugging Face Papers` vào đầu năm `2026`. Paper mô tả đây là một hướng `Generalizable and Efficient Genomic Foundation Model with Multi-scale Contextual Memory`, tức là cố giải bài toán biểu diễn genome với ngữ cảnh dài và đa tỉ lệ bằng một cơ chế bộ nhớ chuyên biệt hơn.
